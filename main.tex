...
\begin{table}[h!]
    ...
    \hline
    Kin num & Q$^2$ \newline (GeV/c)$^2$ & $E_{beam}$ \newline (GeV) & $\theta_e$ & HCal \newline angle & $\pi^+$ \newline end-point \newline angle \newline $\gamma(p,\pi^+)n$ & $E^{max}_{\pi}$ \newline $(\gamma,\pi)$ \newline (GeV) & $E^{max}_{\pi}$ \newline$(\gamma,2\pi)$ \newline(GeV) & $E^{limit}_{\pi}$ \newline$(\gamma,\pi)$ \newline(GeV) & $E^{min}_\gamma$ \newline(GeV) \\
    \hline
    SBS 4 & 3.0 & 3.7393 & 36.0 & 31.9 & 31.5 & 2.120 & 2.037 & 2.068 & 3.577 \\
    SBS 8 & 4.5 & 5.9826 & 26.5 & 29.4 & 30.1 & 3.579 & 3.492 & 3.544 & 5.875 \\
    \rowcolor{blue!20} SBS 9 & 4.5 & 4.0268 & 49.0 & 22.0 & 22.6 & 1.623 & 1.564 & 1.588 & 3.871 \\
    SBS 14 & 7.5 & 5.9828 & 46.5 & 17.0 & 17.7 & 1.999 & 1.950 & 1.979 & 5.875 \\
    SBS 7 & 10 & 7.9308 & 40.0 & 16.1 & 16.5 & 2.659 & 2.610 & 2.649 & 7.887 \\
    SBS 11 & 13.6 & 9.889 & 42 & 13.3 & 12.8 & 2.662 & 2.623 & 2.662 & 9.890 \\
    \hline
    \end{tabular}
    }
...
I've highlighted the SBS 9 kinematic point which was suggested by Andrew to be used in our analysis. But looking at this table, it seems like we can use any kinematic point (maybe except SBS 11 as the end-point energy for the single pion production channel and $E^{limit}_{\pi}$ overlaps) for this analysis?. Please correct me if I am wrong.
